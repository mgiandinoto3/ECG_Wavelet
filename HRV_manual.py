...
def get_hrv(peaks,ybeat,fs):
   ...
   #initialize RR_list variable, calculate RR intervals
    ...
    #power spectral analysis. psd=power spectral density
    frq, psd = signal.periodogram(rr_interp,fs=fs_new)
...
wdata,measures=get_hrv(peaks,ybeat,fs)
